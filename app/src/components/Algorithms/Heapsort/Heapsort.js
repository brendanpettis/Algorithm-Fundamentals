...
class Heapsort extends Component {
  ...
  componentDidMount = () => {
    var arr = [];
      ...
      arr = makeRandArray(10)
      
      var duration = 700; // 700 a good moderate speed
  ...
  render() {
    return (
      ...
      <Card.Header><h1>Heapsort</h1></Card.Header>
      <Card.Body>
        ...
        <Card.Title>Visual Animation (Max Heap)</Card.Title>
        <div id="heapbox"></div>
